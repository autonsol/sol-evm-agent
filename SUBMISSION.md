...
*Last stats update: 2026-04-03 08:50 UTC — **130 all-time trades, 47.7% WR** | Phase 1: +69.9% (57.1% WR, E=+3.33%) | Phase 3: 56.7% WR, -0.5% avg | Phase 5: 44.4% WR | **Phase 18:** 9 trades, **55.6% WR, +1.7% avg, Sharpe 0.215, E=+1.69%** — broke negative-expectancy streak. | **Phase 20:** 2 trades, **100% WR, +6.8% avg** (accumulating). | **Phase 21 (v1.57.0 live):** time_expired cooldown split — drift (<3%) → 60min; middle → 40min; near-TP (≥5%) → 20min. 22 evidence-based strategy iterations in 13 days. | Pitch deck: PITCH-DECK.md*
