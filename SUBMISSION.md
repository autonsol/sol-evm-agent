...
**Updated 2026-04-04:** 15 strategy epochs total. Key milestones: Phase 17 (momentum threshold 3.0x→2.0x) broke the 7h entry deadlock. **Phase 18 (best epoch):** 9 trades, **55.6% WR, +1.7% avg PnL, E=+1.69%/trade** — first consistently positive-expectancy epoch. **Phase 20:** 2 trades, 100% WR, +6.8% avg (small sample, re-entry blacklists working). **Phase 21:** 7 trades, 57.1% WR, -0.3% avg — diagnosed 4/7 time_expired exits averaging +2.3% (positive drift never reaching trailing stop). **Phase 22 (CURRENT, v1.58.0, deployed 2026-04-04T04:49Z):** positive drift hold extension (+2h when pnlPct > 1% at expiry) — 8 trades: trailing_stop 3x avg +3.7% (extended holds reaching real exits ✓), time_expired 5x avg -1.7% (tokens below +1% threshold, correctly gated). E=+0.37%, profit_factor 1.36, max DD -7.7%. Mechanism confirmed: the extended-hold → trailing-stop pipeline is working. WR lower (37.5%) reflects Sunday morning dry market (pre_filter_low_liq dominant); E remains positive. See `/stats → strategy_epochs`.*
...
- [x] Phase 22 positive drift extension live (v1.58.0, 7 trades, E=+1.25%) ✅
...
*Last stats update: 2026-04-05 00:49 EST — **145 all-time trades, 47.6% WR, -0.2% avg** | Phase 1: +69.9% (57.1% WR, E=+3.33%) | Phase 3: 56.7% WR | Phase 5: 56 trades, 48.2% WR | **Phase 18 (v1.53–v1.54, BENCHMARK):** 9 trades, **55.6% WR, +1.7% avg, E=+1.69%**. | **Phase 21 (v1.57.0):** 7 trades, 57.1% WR, -0.3% avg — diagnosed positive drift tokens expiring before trailing stop. | **Phase 22 LIVE (v1.58.0):** 8 trades, **37.5% WR, E=+0.37%, profit_factor 1.36** — exit breakdown: trailing_stop 3x avg +3.7% (extended holds converting to real exits ✓), time_expired 5x avg -1.7% (non-qualifying tokens closed at natural expiry). Max drawdown -7.7%. Mechanism confirmed: extended holds ARE reaching trailing stops; time_expired cohort correctly gated. 15 strategy epochs tracked in /stats. 7 days to April 12 deadline. | Pitch deck: PITCH-DECK.md*
